...
const navLinks = [
  ...
  { label: "Specializace", href: "#speciality" },
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-slate-900/80 backdrop-blur-xl border-b border-white/[0.06] shadow-xl shadow-black/30"
          : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <a href="#" className="flex items-center gap-2.5 group">
            ...
            <div className="flex items-baseline gap-0.5">
              ...
              <span className="font-black text-blue-400 text-lg leading-none ml-1">Černíček</span>
            </div>
          </a>
          ...
          >
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="pt-3 border-t border-white/5">
                <a
                  href="tel:577330485"
                  className="flex items-center gap-2 px-4 py-3 text-blue-400 font-semibold text-sm"
                >
